...
- **Autenticación mediante Llaves Informáticas**: sistema de autenticación sin contraseña basado en número de teléfono celular y códigos OTP enviados vía WhatsApp, con monitoreo de accesos.
- **Cifrado**
    - En tránsito: uso de TLS/HTTPS.
    - En reposo: cifrado en bases de datos y almacenamiento.
- **Registro y monitoreo de seguridad**: bitácoras, alertas y detección de anomalías.
- **Gestión de vulnerabilidades**: parches, revisiones y pruebas de seguridad.
- **Backups y continuidad**: respaldos regulares y procedimientos de recuperación.
...
- **Retiro de consentimiento** cuando el tratamiento se base en consentimiento (sin afectar la licitud del tratamiento previo).
